...
Not surprisingly, our accuracy is about 48%. We are guessing!
...
The accuracy goes up from 0.48 to about 0.79:
...
which is much higher than 0.48. The cutoff resulting in this accuracy is:
...
We see that it is a higher than the accuracy observed for the training set and better than guessing. And by testing on a dataset that we did not train on, we know our result is not due to cherry-picking a good result.
